#' srl_muni - School Read Levels - Physical literacy and reading performance of amazonian schoolchildren
#'
...
#'
#' @format ## `srl_muni' A data frame with 100 rows and 17 columns:
#' \describe{
...
#'   \item{pa}{Pyshical Activity (PA) - Level of physical activity ian children, based on the frequency and duration of routine daily activities. Measured by score on the physical activity frequency questions}
#'   \item{mc}{Motor Competence - Supine To Stand (in seconds) - Measures the time (in seconds) it takes for the child to stand up from the floor, from a supine position to a standing position}
