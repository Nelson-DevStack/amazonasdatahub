...
#'
#' @format ## `humidity_manaus' A tibble with 144 rows and 5 columns
#' \describe{
#'   \item{year}{The year in which this data was observed}
#'   \item{rh}{Relative Humidity}
#'   \item{dbt}{Dry Bulb Temperature}
#'   \item{wbt}{Wet Bulb Temperature}
